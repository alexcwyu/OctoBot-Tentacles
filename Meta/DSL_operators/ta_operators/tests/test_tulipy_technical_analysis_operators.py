...
@pytest.mark.parametrize("operator, parameters", [
    ...
    ("rsi", ["", "(close)", "('a', 14)", "(close, 'a')", "(close, 14, 20)"]),
    ("macd", ["", "(close)", "('a', 14, 26, 9)", "(close, 'a')", "(close, 'a', 26)", "(close, 'a', 26, 9)", "(close, 14, 'a', 9)", "(close, 14, 26, 'a')"]),
    ("ma", ["", "(close)", "('a', 14)", "(close, 'a')", "(close, 14, 20)"]),
    ("ema", ["", "(close)", "('a', 14)", "(close, 'a')", "(close, 14, 20)"]),
    ("vwma", ["", "(close)", "('a', 14)", "(close, 'a')", "(close, 14, 20)"]),
])
async def test_operator_invalid_parameters(interpreter, operator, parameters):
